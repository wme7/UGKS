...
%
% Copyright (C) 2012 Ruijie Wang <lainme993@gmail.com>, Kun Xu <makxu@ust.hk>
%
...
\begin{figure}[htb!]
    ...
    \begin{tikzpicture}[thick]
        ...
        \path[line] node[block,below of=time] (interp) {(reconstruction) \\ calculate slop of h,b in each physical cell}
        (time) edge (interp);
